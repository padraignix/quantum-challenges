...
def join_operators(op1, op2):
    ...
    for i in range(len(op1)):
        if op1[i] == op2[i]:
            join_op.append(op1[i])
        elif op1[i] == 'I':
            join_op.append(op2[i])
        elif op2[i] == 'I':
            join_op.append(op1[i])
    return join_op
    '''
Get-Content 1.in | python .\optimizing_measurements_template.py
[['Z', 'I', 'I', 'I'], ['Z', 'Y', 'I', 'I'], ['X', 'I', 'X', 'Y'], ['I', 'Z', 'I', 'I']]
[['Z', 'Y', 'I', 'I'], ['X', 'Z', 'X', 'Y']]
0.5
Get-Content 2.in | python .\optimizing_measurements_template.py
[['Z', 'X', 'I', 'I'], ['Z', 'Y', 'I', 'I'], ['X', 'I', 'X', 'Y'], ['I', 'Z', 'I', 'I']]
[['Z', 'X', 'I', 'I'], ['Z', 'Y', 'I', 'I'], ['X', 'Z', 'X', 'Y']]0.25
    '''
    # QHACK
